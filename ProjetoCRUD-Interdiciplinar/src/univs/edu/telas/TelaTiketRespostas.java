 ...
 * @author Akari
 */
public class TelaTiketRespostas extends javax.swing.JFrame {
    
    Ticket ticket = new Ticket();
    TicketDAO dao = new TicketDAO();
    
    public TelaTiketRespostas(Funcionario funcionario) {
        initComponents();
        atualizarTabela();
    }
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        TelaTicketFuncionario cadastro = new TelaTicketFuncionario(ticket);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaTiketRespostas.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TelaTiketRespostas(null).setVisible(true);
            }
        });
    }
